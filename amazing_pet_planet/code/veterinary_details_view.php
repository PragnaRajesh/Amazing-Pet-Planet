...
<body>
    ...
    <tr>
      <th width="59">S No </th>
      <th width="200">Veterinary Name </th>
      <th width="200">Veterinary Description </th>
    ...
    <tr>
      ...
      <td><a href="veterinary_details_edit.php?veterinary_id=<?php echo $row['veterinary_id'];?>">Edit</a></td>
      <td><a href="veterinary_details_delete.php?veterinary_id=<?php echo $row['veterinary_id'];?>">delete</a></td>
    </tr>
	<?php
	}
	?>
