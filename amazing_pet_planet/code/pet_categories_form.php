...
<form  action="pet_categories_insert.php" method="post"  name="form1" id="formID">
  <table width="512" height="287" border="0" align="center">
    <tr>
      <td height="90" colspan="2"><div align="center"><span class="style1"><span class="style1">Pet categories </span></span></div></td>
    </tr>
    <tr>
      <td width="199" height="70"><div align="center" class="style2">Pet category name </div></td>
      <td width="303" height="70"><input name="pet_category_name" type="text" id="pet_category_name" class="form-control validate[required]" size="30"></td>
    </tr>
    <tr>
