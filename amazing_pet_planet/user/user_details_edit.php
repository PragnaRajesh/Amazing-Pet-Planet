...
?>
<form name="form1" id="formID" method="post" action="user_details_update.php">
  ...
  <table width="465" height="359" border="0" align="center">
    ...
    <tr>
      ...
      <td height="70"><input name="gender" type="radio" value="male" class="validate[required]" checked>
        Male 
         <input name="gender" type="radio" value="female" class="validate[required]" checked>
        Female</td>
    </tr>
    <tr>
      <td height="70"><div align="center"><span class="style2">Email Id </span></div></td>
      <td height="70"><input name="email_id" readonly="" type="email" id="email_id" class="form-control validate[required,custom[email]]" value="<?php echo $row['email_id'];?>"></td>
    </tr>
    <tr>
