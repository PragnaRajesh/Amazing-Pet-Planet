            ...
            <div id="page-inner">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
						...
						<p>&nbsp;</p>
						<?php include('cal.php');?>
							  <form name="form1" method="post" action="user_payments_view_next.php">
...
&nbsp;&nbsp;&nbsp;</td>
	...
	$s1=1;
	$tot=0;
	$sql="select * from user_payments up,pet_request pr,pet_details pd,user_details ud where up.pet_request_id=pr.pet_request_id and pr.pet_details_id=pd.pet_details_id and pr.user_id=ud.user_id";
