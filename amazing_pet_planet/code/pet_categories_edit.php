...
<form  action="pet_categories_update.php" method="post"  name="form1" id="formID">
  <table width="548" height="287" border="0" align="center">
    ...
    <tr>
      ...
      <td width="276" height="70"><input name="pet_category_name" type="text" id="pet_category_name" class="form-control validate[required]" value="<?php echo $row['pet_category_name'];?>" size="30"></td>
    </tr>
    <tr>
