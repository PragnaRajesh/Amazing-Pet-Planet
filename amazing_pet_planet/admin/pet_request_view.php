...
<body>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                          <thead>
                            <tr>
                              ...
                              <th width="80"><div align="center" class="style8">
                                <div align="left">Reject</div>
                              </div></th>
                            </tr>
                          </thead>
                          <tbody>
	...
	?>
                            <tr>
                              ...
                              <td width="200"><?php if($row['request_status']!='PAID') { ?><a href="pet_accept.php?pet_request_id=<?php echo $row['pet_request_id'];?>" class="btn btn-primary">Accept</a><?php } ?></td>
                              <td width="200"><?php if($row['request_status']!='PAID') { ?><a href="pet_reject.php?pet_request_id=<?php echo $row['pet_request_id'];?>" class="btn btn-danger">Reject</a><?php } ?> </td>
                            </tr>
                            <?php
	}
	?>
