...
<body>
	...
	include('../db_connect/db_connect.php');
	$sl=1;
	$PET_CAT=$_REQUEST['PET_CAT'];
	$sql="select * from pet_details pd,pet_categories pc where pd.pet_category_id=pc.pet_category_id and pd.PET_CAT='$PET_CAT'";
	$res=mysqli_query($conn,$sql);
	while($row=mysqli_fetch_array($res))
	{
	?>
