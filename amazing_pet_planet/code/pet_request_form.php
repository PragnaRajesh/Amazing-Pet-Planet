...
<form name="form1" id="formID" method="post" action="pet_request_insert.php">
  <table width="515" height="601" border="0" align="center">
    ...
    <tr>
      ...
      <td height="70"><input name="request_date" type="date" id="request_date" class="form-control validate[required,custom[date]]"></td>
    </tr>
    <tr>
      <td height="70"><div align="center"><span class="style2">Status</span></div></td>
      <td><input name="status" type="text" id="status" class="form-control validate[required]"></td>
    </tr>
    <tr>
